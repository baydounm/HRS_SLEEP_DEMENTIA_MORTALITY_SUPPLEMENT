...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\DATA_MANAGEMENT.smcl", replace

**STEP 0: OPEN FILES AND CREATE HHIDPN VARIABLE, SORT BY THIS VARIABLE**

cd "F:\HRS_MANUSCRIPT\FINAL_DATA"
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\FIGURE1.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\IMPUTATION.smcl",replace
...
capture log close 
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\SINGLEITEM_SENSITIVITY.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLE1.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\FIGURE2.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\FIGURE3.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLE2.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLE3.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLE3B.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLE4.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLE5.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLES3.smcl",replace
...
capture log close
capture log using "F:\HRS_MANUSCRIPT\OUTPUT\TABLES4.smcl",replace
